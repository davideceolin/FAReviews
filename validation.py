...
#df['weight'] = (df['unixReviewTime']-df['unixReviewTime'].min())/(df['unixReviewTime'].max()-df['unixReviewTime'].min())
...
print(pd.pivot_table(df[['cluster_labels', 'vote']], aggfunc=np.mean, index='cluster_labels', values='vote'))
print(pd.pivot_table(df[['cluster_labels', 'vote']], aggfunc=np.sum, index='cluster_labels', values='vote'))
print(pd.pivot_table(df[['cluster_labels', 'vote']], aggfunc=np.std, index='cluster_labels', values='vote'))
'''

# print(pd.pivot_table(df[['cluster_labels', 'weighted_vote']], aggfunc=np.mean, index='cluster_labels', values='weighted_vote'))
# print(pd.pivot_table(df[['cluster_labels', 'weighted_vote']], aggfunc=np.sum, index='cluster_labels', values='weighted_vote'))

'''
print("Precision @1 K-means:")
print(len(df.loc[(df['vote'] >= 1) & (df['cluster_labels'] == 1), 'cluster_labels'])/len(df.loc[df['cluster_labels'] == 1, 'vote']))
print("Precision @5 K-means:")
print(len(df.loc[(df['vote'] >= 5) & (df['cluster_labels'] == 1), 'cluster_labels'])/len(df.loc[df['cluster_labels'] == 1, 'vote']))
print("Precision @10 K-means:")
print(len(df.loc[(df['vote'] >= 10) & (df['cluster_labels'] == 1), 'cluster_labels'])/len(df.loc[df['cluster_labels'] == 1, 'vote']))

print("Recall @1 K-means:")
print(len(df.loc[(df['vote'] >= 1) & (df['cluster_labels'] == 1), 'cluster_labels'])/len(df.loc[df['vote'] >= 1, 'vote']))
print("Recall @5 K-means:")
print(len(df.loc[(df['vote'] >= 5) & (df['cluster_labels'] == 1), 'cluster_labels'])/len(df.loc[df['vote'] >= 5, 'vote']))
print("Recall @10 K-means:")
print(len(df.loc[(df['vote'] >= 10) & (df['cluster_labels'] == 1), 'cluster_labels'])/len(df.loc[df['vote'] >= 10, 'vote']))

print("PrecisionW @1 K-means:")
print(np.sum(df.loc[(df['vote'] >= 1) & (df['cluster_labels'] == 1), 'cluster_labels'])/np.sum(df.loc[df['cluster_labels'] == 1, 'vote']))
print("PrecisionW @5 K-means:")
print(np.sum(df.loc[(df['vote'] >= 5) & (df['cluster_labels'] == 1), 'cluster_labels'])/np.sum(df.loc[df['cluster_labels'] == 1, 'vote']))
print("PrecisionW @10 K-means:")
print(np.sum(df.loc[(df['vote'] >= 10) & (df['cluster_labels'] == 1), 'cluster_labels'])/np.sum(df.loc[df['cluster_labels'] == 1, 'vote']))

print("RecallW @1 K-means:")
print(np.sum(df.loc[(df['vote'] >= 1) & (df['cluster_labels'] == 1), 'cluster_labels'])/np.sum(df.loc[df['vote'] >= 1, 'vote']))
print("RecallW @5 K-means:")
print(np.sum(df.loc[(df['vote'] >= 5) & (df['cluster_labels'] == 1), 'cluster_labels'])/np.sum(df.loc[df['vote'] >= 5, 'vote']))
print("RecallW @10 K-means:")
print(np.sum(df.loc[(df['vote'] >= 10) & (df['cluster_labels'] == 1), 'cluster_labels'])/np.sum(df.loc[df['vote'] >= 10, 'vote']))
'''
...
# df_features['weight'] = (df['unixReviewTime']-df['unixReviewTime'].min())/(df['unixReviewTime'].max()-df['unixReviewTime'].min()) #df['unixReviewTime'].apply(lambda x: ((np.log10(x)-9)*10)-1)
df_features['cluster'] = df['vote'].apply(lambda x: 0 if x < 10 else 1) #df_features['weighted_vote'].apply(round)
...
print(len(testset.loc[(testset['vote'] >= 1) & (testset['cluster'] == 1), 'cluster'])/len(testset.loc[testset['cluster'] == 1, 'vote']))
print("Precision @5 SVC@10:")
print(len(testset.loc[(testset['vote'] >= 5) & (testset['cluster'] == 1), 'cluster'])/len(testset.loc[testset['cluster'] == 1, 'vote']))
print("Precision @10 SVC@10:")
print(len(testset.loc[(testset['vote'] >= 10) & (testset['cluster'] == 1), 'cluster'])/len(testset.loc[testset['cluster'] == 1, 'vote']))

print("Recall @1 SVC@10:")
print(len(testset.loc[(testset['vote'] >= 1) & (testset['cluster'] == 1), 'cluster'])/len(testset.loc[testset['vote'] >= 1, 'vote']))
print("Recall @5 SVC@10:")
print(len(testset.loc[(testset['vote'] >= 5) & (testset['cluster'] == 1), 'cluster'])/len(testset.loc[testset['vote'] >= 5, 'vote']))
print("Recall @10 SVC@10:")
print(len(testset.loc[(testset['vote'] >= 10) & (testset['cluster'] == 1), 'cluster'])/len(testset.loc[testset['vote'] >= 10, 'vote']))
'''
print("PrecisionW @1 SVC@10:")
print(np.sum(testset.loc[(testset['vote'] >= 1) & (testset['cluster'] == 1), 'cluster'])/np.sum(testset.loc[testset['cluster'] == 1, 'vote']))
print("PrecisionW @5 SVC@10:")
print(np.sum(testset.loc[(testset['vote'] >= 5) & (testset['cluster'] == 1), 'cluster'])/np.sum(testset.loc[testset['cluster'] == 1, 'vote']))
print("PrecisionW @10 SVC@10:")
print(np.sum(testset.loc[(testset['vote'] >= 10) & (testset['cluster'] == 1), 'cluster'])/np.sum(testset.loc[testset['cluster'] == 1, 'vote']))

print("RecallW @1 SVC@10:")
print(np.sum(testset.loc[(testset['vote'] >= 1) & (testset['cluster'] == 1), 'cluster'])/np.sum(testset.loc[testset['vote'] >= 1, 'vote']))
print("RecallW @5 SVC@10:")
print(np.sum(testset.loc[(testset['vote'] >= 5) & (testset['cluster'] == 1), 'cluster'])/np.sum(testset.loc[testset['vote'] >= 5, 'vote']))
print("RecallW @10 SVC@10:")
print(np.sum(testset.loc[(testset['vote'] >= 10) & (testset['cluster'] == 1), 'cluster'])/np.sum(testset.loc[testset['vote'] >= 10, 'vote']))
scores = cross_val_score(clf, df_features.drop('cluster', axis=1).drop('vote', axis=1), df_features['cluster'], cv=3)
print("Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
'''

df_features['vote'] = df['vote']
#df_features['weighted_vote'] = df['weight']*df['vote'].apply(lambda x: 0 if x < 5 else 1)
df_features['cluster'] = df['vote'].apply(lambda x: 0 if x < 5 else 1) #df_features['weighted_vote'].apply(round)
...
# print(pd.pivot_table(testset[['cluster', 'weighted_vote']], aggfunc=np.mean, index='cluster', values='weighted_vote'))
# print(pd.pivot_table(testset[['cluster', 'weighted_vote']], aggfunc=np.sum, index='cluster', values='weighted_vote'))
...
scores = cross_val_score(clf, X=df_features.drop(columns=['cluster', 'vote', 'weighted_vote']), y=df_features['vote'], cv=3)
print("Accuracy: %0.2f (+/- %0.2f)" % (scores.mean(), scores.std() * 2))
print(scores)